...
public class ReservationController_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.catalyte.training.hotel_room_booking.Controllers.ReservationController"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ReservationController_ESTest_scaffolding.class.getClassLoader() ,
      "com.catalyte.training.hotel_room_booking.Entities.Reservation",
      ...
      "com.catalyte.training.hotel_room_booking.CustomExceptions.ReservationNotFound",
      "com.catalyte.training.hotel_room_booking.CustomExceptions.RoomTypeFull",
      "org.springframework.data.repository.PagingAndSortingRepository",
      "com.catalyte.training.hotel_room_booking.Controllers.ReservationController",
      ...
      "com.catalyte.training.hotel_room_booking.Repositories.ReservationRepository",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.catalyte.training.hotel_room_booking.Repositories.ReservationRepository", false, ReservationController_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ReservationController_ESTest_scaffolding.class.getClassLoader()); 
